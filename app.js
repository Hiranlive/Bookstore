...
//Connect to Mongoose
mongoose.connect('mongodb://hiran:hiran@ec2-54-226-115-31.compute-1.amazonaws.com:27017/bookstore');
...
app.get('/api/genres', function function_name(req, res) {
...
app.post('/api/genres', function function_name(req, res) {
	var genre = req.body;
...
app.put('/api/genre/:_id', function function_name(req, res) {
